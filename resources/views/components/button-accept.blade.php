...
<div x-data="{ open:false }" @modal:close.stop="open=false" x-id="['modal']">
  <button type="button" @click="open=true"
          class="bg-green-200 p-2 ml-2 rounded-full transition hover:bg-green-300"
    ...
    <div class="bg-white rounded-3xl p-8 w-[800px] max-h-[80vh] shadow-lg overflow-y-auto" @click.stop>
      ...
      <form class="space-y-4 text-black ajax-form" action="{{ $action }}" method="POST">
        ...
        <div class="flex justify-end mt-6">
            ...
            <button type="submit"
                    class="js-confirm bg-green-300 text-gray-700 py-2 px-4 rounded-full flex items-center hover:bg-green-400 justify-center">
